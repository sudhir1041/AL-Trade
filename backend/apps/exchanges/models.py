...
class Exchange(models.Model):
    ...
    supports_futures     = models.BooleanField(default=False, verbose_name="Supports Futures")
    supports_spot        = models.BooleanField(default=True,  verbose_name="Supports Spot")
    supports_websocket   = models.BooleanField(default=False, verbose_name="Supports WebSocket")
    sandbox_available    = models.BooleanField(default=False, verbose_name="Sandbox Available")
    phase                = models.IntegerField(
        default=1,
        verbose_name="Integration Phase",
        help_text="1 = Phase 1 (core), 2 = Phase 2 (extended).",
    )
    api_docs_url         = models.URLField(max_length=512, blank=True, verbose_name="API Docs URL")
    rate_limit_per_minute = models.IntegerField(default=60, verbose_name="Rate Limit / Minute")
...
class ExchangeAccount(TenantAwareModel):
    ...
    last_sync_at             = models.DateTimeField(null=True, blank=True, verbose_name="Last Synced At")
    balance_synced_at        = models.DateTimeField(null=True, blank=True, verbose_name="Balance Synced At")
...
class ExchangeConnection(models.Model):
    ...
    disconnected_at      = models.DateTimeField(null=True, blank=True, verbose_name="Disconnected At")
    ...
    websocket_session_id = models.CharField(max_length=255, blank=True, verbose_name="WebSocket Session ID")
